        ...
        <div className="flex flex-col items-center justify-around bg-white p-8 h-full">
            ...
            <div className="flex">
                {macbookModels.map((mb, index) => (
                    <button key={index} className={`2xl:w-36 md:w-26 w-28 2xl:h-18 md:h-12 h-12 flex flex-col 
                    justify-evenly items-center border ${index === 0 ? "rounded-l-xl" : "rounded-r-xl"} 
            ...
            <div className="flex flex-col 2xl:p-4 md:items-start items-center">
                <div className="w-80 h-64 2xl:mb-0 -mb-8">
                    <img
                        ...
                        alt={`Macbook air wtih ${currentMb.chip}`}
                    ...
                    {currentMb.colors.map((col, index) => (
                        <button
                            ...
                            className={`2xl:w-6 sm:w-5 w-4 2xl:h-6 sm:h-5 h-4 bg-[#2e3641] 
                                    rounded-full border hover:border-blue-500 ${selectedColor === index
                ...
                <img src={currentMb.icon} alt={`Apple ${currentMb.icon} icon`} className="w-12 h-12 2xl:mb-4 xl:mb-2" />
