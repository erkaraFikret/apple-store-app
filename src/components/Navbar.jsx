...
const Navbar = ({ activePage, handleNavClick, isNavbarOpen, toggleNavbar }) => {
    return (
        <>
            <div className={`2xl:w-80 xl:w-52 w-44 h-full bg-[#f8f8f8] flex flex-col 
                justify-between pt-5 pl-6 absolute md:relative z-10 transition-transform duration-300 ${isNavbarOpen ? "translate-x-0" : "-translate-x-full"} `}>
                <a href="" className="2xl:text-2xl xl:text-xl font-light mb-14 tracking-wider text-red-600 md:pb-0 ">
                    Apple Store App
                </a>
                ...
                <div className="flex justify-between pr-6 pb-14">
                    <a href="#">
